...
export const initialInterestGroupMembers: InterestGroupMember[] = [
  ...
  { groupId: 2, employeeId: '林销', name: '林销', department: '华南大区', role: 'member', status: '已通过', joinedAt: '2026-03-01 16:20:00' },
  ...
  { groupId: 4, employeeId: '吴检', name: '吴检', department: '质检部', role: 'lead', status: '已通过', joinedAt: '2026-02-22 18:00:00' },
  { groupId: 4, employeeId: '钱会', name: '钱会', department: '财务', role: 'member', status: '已通过', joinedAt: '2026-04-11 12:00:00' },
  { groupId: 3, employeeId: '林浅', name: '林浅', department: '前端组', role: 'member', status: '已通过', joinedAt: '2026-05-20 12:00:00' },
  { groupId: 4, employeeId: '林浅', name: '林浅', department: '前端组', role: 'member', status: '已通过', joinedAt: '2026-04-02 18:30:00' },
  { groupId: 5, employeeId: '林浅', name: '林浅', department: '前端组', role: 'lead', status: '已通过', joinedAt: '2026-08-20 12:10:00' },
  { groupId: 6, employeeId: '林浅', name: '林浅', department: '前端组', role: 'lead', status: '已通过', joinedAt: '2026-08-12 12:20:00' },
  { groupId: 7, employeeId: '林浅', name: '林浅', department: '前端组', role: 'lead', status: '已通过', joinedAt: '2026-08-15 19:00:00' },
];
