...
export function planInterestGroupActivity(
  ...
  const planned: InterestGroupActivityFormValues = isHike
    ? alignForm({
        ...
        categoryKey: 'sport',
        type: 'series',
        startAt: '2026-09-12 04:30',
        endAt: '2026-09-26 14:00',
        sessions: [
          { startAt: '2026-09-12 04:30', endAt: '2026-09-12 14:00' },
          { startAt: '2026-09-26 04:30', endAt: '2026-09-26 14:00' },
        ],
        signupHoursBefore: 2,
        location: '云栖谷停车场 (统一拼车)',
        capacity: 24,
        detailHtml:
          '<p>凌晨集合拼车前往云栖谷，<b>登顶迎接第一缕阳光</b>，溪谷线下撤。</p><ul><li>全程约 9 公里、累计爬升 600m，中级强度</li><li>领队持野外急救证，提供保险与能量补给</li><li>需登山鞋，头灯由兴趣圈统一准备</li></ul>',
        coverUrl: '',
      })
    : isRun
      ? alignForm({
          ...
          categoryKey: 'sport',
          type: 'recurring',
          startAt: '2026-09-02 19:30',
          endAt: '2026-10-28 21:00',
          repeatRules: [{ weekday: 3, timeStart: '19:30', timeEnd: '21:00' }],
          signupHoursBefore: 2,
          location: '滨江园区南门集合',
          capacity: 40,
          detailHtml:
      ...
      : alignForm({
          ...
          categoryKey: 'game',
          type: 'once',
          startAt: '2026-09-10 12:30',
          endAt: '2026-09-10 13:20',
          signupStartAt: '2026-09-01 09:00',
          signupEndAt: '2026-09-10 12:00',
          location: '休闲区 3 号桌',
          capacity: 10,
          detailHtml:
