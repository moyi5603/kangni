...
def main():
    with sync_playwright() as p:
        ...
        goto(page, "#/interest-groups/interest-group-activities", ".ant-layout")
        ...
        goto(page, "#/interest-groups/interest-group-detail/1", ".ant-layout")
        ...
        goto(page, "#/interest-groups/interest-group-list", ".ant-layout")
